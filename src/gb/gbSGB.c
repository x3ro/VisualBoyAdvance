...
static void gbSgbFillScreen(u16 color)
{
...
static void gbSgbRenderScreenToBuffer()
{
...
static void gbSgbDrawBorderTile(int x, int y, int tile, int attr)
{
...
static void gbSgbSetPaletteB(int a,int b,u16 *p)
{
...
static void gbSgbScpPalette(void)
{
  gbSgbRenderScreenToBuffer();
...
static void gbSgbSetPalette(void)
{
...
static void gbSgbAttributeBlock(void)
{
...
static void gbSgbSetColumnPalette(u8 col, u8 p)
{
  //  if(col < 0)
  //    col = 0;
  if(col > 19)
...
static void gbSgbSetRowPalette(u8 row, u8 p)
{
  //  if(row < 0)
  //    row = 0;
  if(row > 17)
...
static void gbSgbAttributeDivide(void)
{
...
static void gbSgbAttributeLine(void)
{
  u8 *fromAddress = &gbSgbPacket[1];
...
static void gbSgbAttributeCharacter(void)
{
...
static void gbSgbSetATFList(void)
{
  gbSgbRenderScreenToBuffer();
...
static void gbSgbMaskEnable(void)
{
...
static void gbSgbChrTransfer(void)
{
  gbSgbRenderScreenToBuffer();
...
static void gbSgbMultiRequest(void)
{
  if(gbSgbPacket[1] & 1) {
    gbSgbMultiplayer    = 1;
    if(gbSgbPacket[1] & 2)
...
void gbSgbCommand(void)
{
  ...
  switch(command) {
  case 0x00:
    gbSgbSetPaletteB(0,1,(u16 *)&gbSgbPacket[1]);
    break;
  case 0x01:
    gbSgbSetPaletteB(2,3,(u16 *)&gbSgbPacket[1]);
    break;
  case 0x02:
    gbSgbSetPaletteB(0,3,(u16 *)&gbSgbPacket[1]);
    break;
  case 0x03:
    gbSgbSetPaletteB(1,2,(u16 *)&gbSgbPacket[1]);
    break;
  case 0x04:
    gbSgbAttributeBlock();
    break;
