...
if(cond_res) {
  ...
  case 0x10b:
    ...
    base = (opcode >> 16) & 0x0F;
    dest = (opcode >> 12) & 0x0F;
    address = reg[base].I - reg[opcode & 0x0F].I;
    clockTicks = 4;
    CPUWriteHalfWord(address, reg[dest].W.W0);
    break;
  case 0x12b:
  ...
  case 0x14b:
    ...
    base = (opcode >> 16) & 0x0F;
    dest = (opcode >> 12) & 0x0F;
    address = reg[base].I - ((opcode & 0x0F)|((opcode>>4)&0xF0));
    clockTicks = 4;
    CPUWriteHalfWord(address, reg[dest].W.W0);
    break;
  case 0x16b:
  ...
  case 0x089:
    ...
    destLo = (opcode >> 12) & 0x0F;         
    destHi = (opcode >> 16) & 0x0F;
  ...
  case 0x109:
    // SWP Rd, Rm, [Rn]
    address = reg[(opcode >> 16) & 15].I;
    temp = CPUReadMemory(address);
  ...
  case 0x628:
    // STR Rd, [Rn], -Rm, LSL #
    offset = reg[opcode & 15].I << ((opcode>>7)& 31);
    dest = (opcode >> 12) & 15;
    base = (opcode >> 16) & 15;
    address = reg[base].I;
    CPUWriteMemory(address, reg[dest].I);
  ...
  case 0x62a:
    // STR Rd, [Rn], -Rm, LSR #
    shift = (opcode >> 7) & 31;
    offset = shift ? reg[opcode & 15].I >> shift : 0;
    dest = (opcode >> 12) & 15;
    base = (opcode >> 16) & 15;
    address = reg[base].I;
    CPUWriteMemory(address, reg[dest].I);
