...
#define LOGICAL_DATA_OPCODE(OPCODE, OPCODE2, BASE) \
  ...
  case BASE+8:\
    {\
      ...
      if(dest == 15) {\
        clockTicks+=2+2*codeTicksAccessSeq32(armNextPC);\
        OPCODE2\
        /* todo */\
...
if(cond_res) {
  ...
  case 0x009:
    {
      ...
      clockTicks = codeTicksAccess32(armNextPC) + 2; 
      ...
      if((rs & 0xFFFFFF00) == 0)
        ...
        clockTicks += 3;
      busPrefetchCount += clockTicks - codeTicksAccess32(armNextPC) -1;
    }
    break;
  case 0x019:
    {
  ...
  case 0x03b:
    {
      ...
      if(dest == 15) {
        ...
        reg[15].I += 4;
        ARM_PREFETCH;
        clockTicks += 2 + 2*dataTicksAccessSeq32(address);
      }
  ...
  case 0x13b:
    {
      ...
      clockTicks = 0;
      if(dest == 15) {
        clockTicks += 2 + 2*codeTicksAccessSeq32(address);
        reg[15].I &= 0xFFFFFFFC;
        armNextPC = reg[15].I;
        reg[15].I += 4;
        ARM_PREFETCH;
  ...
  case 0x029:
    {
      // MLA Rd, Rm, Rs, Rn
      clockTicks = codeTicksAccess32(armNextPC) + 3;
      int dest = (opcode >> 16) & 0x0F;
      int mult = (opcode & 0x0F);
      u32 rs = reg[(opcode >> 8) & 0x0F].I;
  ...
  case 0x109:
    {
      ...
      clockTicks = codeTicksAccess32(armNextPC) +
          2*dataTicksAccess32(address) +4;
    }
    break;
  ...
  case 0x121:
    {
      ...
      busPrefetchCount=0;
      clockTicks = 2*dataTicksAccess32(armNextPC) + codeTicksAccess32(armNextPC) + 3;
    }
    break;
